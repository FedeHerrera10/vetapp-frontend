...
export const SectionServices = () => {
  return (
    <section id='servicios'>
        <p className="my-14 md:mt-28 xl:mt-40 text-xl font-normal leading-relaxed md:leading-normal md:text-2xl text-zinc-800 lg:text-3xl lg:leading-relaxed"> En VetApp podes encontrar una amplia gama de <span className="text-indigo-500">
       ...
       <div className="flex flex-col gap-3 md:grid md:grid-cols-3 grid-rows-2 xl:gap-5">
       <div className="bg-indigo-400 p-4 rounded text-slate-50 h-80 flex flex-col justify-between ">
            <div>
