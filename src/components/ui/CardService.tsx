...
export const CardService = ({ title, imgsrc }: CardProp) => {
  return (
    <div
      className="bg-slate-50  p-4  flex flex-col  h-80 cursor-pointer hover:border-l-indigo-400 
    ...
    "
    >
      <h2 className="text-zinc-700 text-xl font-semibold uppercase 2xl:text-2xl">
        {title}
      </h2>
      {imgsrc}
